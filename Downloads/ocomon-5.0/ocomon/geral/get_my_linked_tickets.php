...
$sql = $QRY["ocorrencias_full_ini"] . " WHERE stat_ignored <> 1 AND s.stat_painel in (1) AND 
            ( o.operador = " . $_SESSION['s_uid'] . " {$terms} ) AND o.oco_scheduled=0 ORDER BY numero";
...
$sql = $QRY["ocorrencias_full_ini"] . " WHERE stat_ignored <> 1 AND s.stat_painel in (1) AND 
            (o.operador = " . $_SESSION['s_uid'] . " {$terms}) AND o.oco_scheduled=0 ";
